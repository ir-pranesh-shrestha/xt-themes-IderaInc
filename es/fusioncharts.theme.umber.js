...
*//* jshint ignore:start *//* jshint ignore:end */var themeObject = { name: 'umber',
  theme: { base: { chart: {// chart body and canvas customization
    // border
    showBorder: 0,
    showCanvasBorder: 0, // background
    bgColor: '#FFF1E5',
    bgAlpha: 100,
    canvasBgAlpha: 0, // other canvas customization's
    showAlternateHGridColor: 0,
    showAlternateVGridColor: 0, // text - font and font style customization
    ...
    captionPadding: 20, // axis titles (x and y axis names) customization
    ...
    vDivLinealpha: 100,
    vDivLineThickness: 0.75, // plot customization
    paletteColors: '#0f5499, #B5323E, #0a5e66, #EDB34A, #676668, #ED9CBD, #4CCBB8, #B9C36C, #749FC0, #FC6D6D',
    usePlotGradientColor: 0,
    showPlotBorder: 0,
    showShadow: 0,
    use3DLighting: 0, // tooltip and crossline customization
    ...
    tooltipBgAlpha: 90, // crossline customization
    crossLineColor: '#D5CDBE',
    crossLineAlpha: 100,
    crossLineThickness: 1, // legend customization
    legendBgAlpha: 0,
    legendBorderThickness: 0,
    legendIconScale: 1,
    drawCustomLegendIcon: 1,
    legendShadow: 0, // hover effect customization
    showHoverEffect: 1,
    plotHoverEffect: 1,
    anchorHoverEffect: 0,
    plotFillHoverAlpha: 85,
    plotBorderHoverThickness: 0,
    plotBorderHoverAlpha: 0, // toolbar customization
    toolbarButtonColor: '#FFF1E5',
    toolbarButtonHoverColor: '#FFF9F5',
    toolbarButtonBorderColor: '#D5CDBE',
    toolbarButtonBorderThickness: 0.5,
    toolbarButtonScale: 1.3, // axis customization
    transposeAxis: 1,
    setAdaptiveYMin: 1,
    setAdaptiveXMin: 1 } }, // column2d chart (1)
  ...
  doughnut2d: { chart: { showLegend: 1,
    ...
    centerLabelColor: '#33302E', // setting default as null
    defaultCenterLabel: null,
    centerLabel: null } }, // doughnut3d chart (10)
  ...
  category: [{ color: '#33302E', category: [{ color: '#0F5499', alpha: 85, category: [{ color: '#0F5499', alpha: 70, category: [{ color: '#0F5499', alpha: 55 }] }] }] }] }, // select-scatter chart (91)
  ...
  chord: { chart: { drawCustomLegendIcon: 0, legendPosition: 'right', nodeThickness: 10, nodeLabelColor: '#606060', nodeLabelFontSize: 11, nodeLabelPosition: 'outside', nodeHoverAlpha: 100, nodeLinkPadding: 0, nodeSpacing: 3, nodeBorderThickness: 0, nodeAlpha: 80, linkAlpha: 40, linkBorderAlpha: 40, linkHoverAlpha: 75 } },
  radialBar: { chart: { legendIconSides: '2', labelPadding: '6px 10px 6px 10px' } }, // multi-series stacked Bar2D chart (108)
