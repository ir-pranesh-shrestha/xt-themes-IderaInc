...
*/var themeObject = { name: 'gammel',
  theme: { base: { chart: {// plot customization
    ...
    showPlotBorder: '0',
    showShadow: '0', // chart and canvas background and padding customization
    showBorder: '0',
    showCanvasBorder: '0',
    bgColor: '#FFFFFF',
    bgAlpha: '100',
    canvasBgAlpha: '0', // axis and grid lines customization
    ...
    labelDisplay: 'AUTO',
    transposeAxis: '1',
    showCanvasBase: '0', // tooltip customization
    tooltipColor: '#333333',
    ...
    showToolTipShadow: '1', // font and text size customization
    baseFontSize: '11',
    ...
    textOutline: 1, // legend customization
    showLegend: '1',
    legendBgAlpha: '0',
    ...
    legendItemHiddenColor: '#CCCCCC', // cross line customization
    drawCrossLineOnTop: '0',
    crossLineThickness: '1',
    crossLineColor: '#E6E6E6',
    crossLineAlpha: '60', // hover effect
    showHoverEffect: '1',
    plotHoverEffect: '1',
    plotFillHoverAlpha: '95',
    columnHoverAlpha: '95', // scroll customization
    scrollColor: '#808080',
    scrollHeight: '11',
    flatscrollbars: '1',
    scrollshowbuttons: '1' } }, // 1. Column 2D
  ...
  pie2d: { chart: { showZeroPies: '1', plotToolText: '$label: <b>$dataValue</b>', showPercentValues: '1', showPercentInToolTip: '0', labelSepChar: ': ', use3DLighting: '0', enableMultiSlicing: '0', isSmartLineSlanted: '0', smartLineColor: '#434348', smartLineThickness: '1', smartLabelClearance: '0' }, data: function (b, a, c) { a = window.Math; return { alpha: 100 - (c > 50 ? a.round(100 / a.ceil(c / 10)) : 20) * a.floor(b / 10) }; } }, // 8. Pie 3D
  pie3d: { chart: { showZeroPies: '1', plotToolText: '$label: <b>$dataValue</b>', showPercentValues: '1', showPercentInToolTip: '0', labelSepChar: ': ', use3DLighting: '0', enableMultiSlicing: '0', pieYScale: '75', pieSliceDepth: '10', isSmartLineSlanted: '0', smartLineColor: '#434348', smartLineThickness: '1', smartLabelClearance: '0' }, data: function (b, a, c) { a = window.Math; return { alpha: 100 - (c > 50 ? a.round(100 / a.ceil(c / 10)) : 20) * a.floor(b / 10) }; } }, // 9. Doughnut 2D
  doughnut2d: { chart: { showZeroPies: '1', plotToolText: '$label: <b>$dataValue</b>', showPercentValues: '1', showPercentInToolTip: '0', labelSepChar: ': ', use3DLighting: '0', enableMultiSlicing: '0', isSmartLineSlanted: '0', smartLineColor: '#434348', smartLineThickness: '1', smartLabelClearance: '0' }, data: function (b, a, c) { a = window.Math; return { alpha: 100 - (c > 50 ? a.round(100 / a.ceil(c / 10)) : 20) * a.floor(b / 10) }; } }, // 10. Doughnut 3D
  doughnut3d: { chart: { showZeroPies: '1', plotToolText: '$label: <b>$dataValue</b>', showPercentValues: '1', showPercentInToolTip: '0', labelSepChar: ': ', use3DLighting: '0', enableMultiSlicing: '0', pieYScale: '75', pieSliceDepth: '10', isSmartLineSlanted: '0', smartLineColor: '#434348', smartLineThickness: '1', smartLabelClearance: '0' }, data: function (b, a, c) { a = window.Math; return { alpha: 100 - (c > 50 ? a.round(100 / a.ceil(c / 10)) : 20) * a.floor(b / 10) }; } }, // 11. Pareto 2D
  ...
  geo: { chart: { showLabels: '0', legendScaleLineThickness: '0', legendaxisborderalpha: '0', legendShadow: '0', fillColor: '#E6E6E6', showEntityHoverEffect: '1', entityFillHoverAlpha: '70', connectorHoverAlpha: '70', markerBorderHoverAlpha: '70', showBorder: '1', borderColor: '#434348', borderThickness: '0.3', nullEntityColor: '434348', nullEntityAlpha: '30', entityFillHoverColor: '#434348' }, colorrange: { gradient: '1', code: '#7CB5EC' } }, // 95 Overlapped Bar2D Chart
  overlappedbar2d: { chart: { yAxisValuesPadding: '10', showValues: '0', drawCrossLine: '1' } }, // 96 Overlapped Column2D Chart
  overlappedcolumn2d: { chart: { showValues: '0', drawCrossLine: '1' } }, // 97 Scroll Bar2D Chart
  scrollbar2d: { chart: { showLegend: '1', showShadow: '0', adjustDiv: '1', flatScrollBars: '1', scrollShowButtons: '1', scrollHeight: '15', scrollColor: '#F3F3F3' } }, // 98 Scroll Stacked Bar2D
  scrollstackedbar2d: { chart: { showValues: '0', showSum: '1', showLegend: '1', showShadow: '0', adjustDiv: '1', flatScrollBars: '1', scrollShowButtons: '1', scrollHeight: '15', scrollColor: '#F3F3F3' } }, // 99 Scroll Multi-series Stacked Column2D
  scrollmsstackedcolumn2d: { chart: { showShadow: '0', drawAnchors: '1', anchorRadius: '4', anchorHoverRadius: '6', showValues: '0', anchorBorderHoverColor: '#D8D8D8', anchorHoverEffect: '1', anchorBgHoverAlpha: '95', anchorBorderHoverThickness: '2', drawCrossLine: '1', legendIconBorderThickness: '1', adjustDiv: '1', flatScrollBars: '1', scrollShowButtons: '1', scrollHeight: '15', scrollColor: '#F3F3F3' } }, // 100 Scroll Multi-series Stacked Column2D + Line Dual Y-Axis Chart
  scrollmsstackedcolumn2dlinedy: { chart: { drawAnchors: '1', anchorRadius: '4', anchorHoverRadius: '6', showValues: '0', anchorBorderHoverColor: '#D8D8D8', anchorHoverEffect: '1', anchorBgHoverAlpha: '95', anchorBorderHoverThickness: '2', drawCrossLine: '1', legendIconBorderThickness: '1', flatScrollBars: '1', scrollShowButtons: '1', scrollHeight: '15', scrollColor: '#F3F3F3' } }, // 101 Stacked Column2D + Line Dual Y-Axis Chart
  stackedcolumn2dlinedy: { chart: { drawAnchors: '1', anchorRadius: '4', anchorHoverRadius: '6', showValues: '0', anchorBorderHoverColor: '#D8D8D8', anchorHoverEffect: '1', anchorBgHoverAlpha: '95', anchorBorderHoverThickness: '2', drawCrossLine: '1', legendIconBorderThickness: '1' } }, // 102 Stacked Area2D + Line Dual Y-Axis Chart
  ...
  chord: { chart: { drawCustomLegendIcon: 0, showLegend: 0, nodeLabelColor: '#000000', nodeLabelFontBold: 1, nodeLabelFontSize: 11, nodeLabelPosition: 'outside', nodeAlpha: 100, nodeHoverAlpha: 100, linkAlpha: 50, linkBorderAlpha: 50, linkHoverAlpha: 100, nodeBorderThickness: 0, nodeSpacing: 2, nodeThickness: 11, nodeLinkPadding: 4 } },
  radialBar: { chart: { labelPadding: '6px 10px 6px 10px' } }, // 108. Multi-series Stacked Bar2D Chart
  msstackedbar2d: { chart: { showValues: '0', showSum: '0', drawCrossLine: '0' } }, // timeseries
