...
msarea:{chart:{drawAnchors:0,anchorBgColor:'#FFF1E5',plotFillAlpha:50,legendIconBgAlpha:50,legendIconBorderAlpha:0,legendIconSides:2,drawCrossLine:1,anchorBgColor:'#FFF1E5',anchorBorderThickness:2,plotHoverEffect:0}},// marimekko chart (19)
...
stackedarea2d:{chart:{drawAnchors:0,anchorBgColor:'#FFF1E5',plotFillAlpha:85,legendIconBgAlpha:85,legendIconBorderAlpha:0,legendIconSides:2,drawCrossLine:1,anchorBgColor:'#FFF1E5',anchorBorderThickness:2,plotHoverEffect:0}},// multi-series stacked column2D chart (27)
...
vled:{chart:{captionAlignment:'center',setAdaptiveMin:1,showGaugeBorder:0,setAdaptiveMin:1,adjustTM:1,placeTicksInside:0,autoAlignTickValues:1,minortmnumber:0,majorTMHeight:10,majorTMColor:'#D5CDBE',ledGap:0,valueFont:'Titillium Web SemiBold',valueFontSize:12,valueFontColor:'#33302E',baseFontColor:'#33302E'}},// real-time area chart (53)
...
mssplinearea:{chart:{drawAnchors:0,anchorBgColor:'#FFF1E5',plotFillAlpha:50,legendIconBgAlpha:50,legendIconBorderAlpha:0,legendIconSides:2,drawCrossLine:1,anchorBgColor:'#FFF1E5',anchorBorderThickness:2,plotHoverEffect:0}},// error bar chart (73)
...
geo:{chart:{showLabels:0,legendScaleLineThickness:0,legendaxisborderalpha:0,legendPointerColor:'#FFF9F5',legendpointerbordercolor:'#606060',legendPointerAlpha:85,fillColor:'#0f5499',showEntityHoverEffect:1,entityFillHoverAlpha:85,connectorHoverAlpha:85,markerBorderHoverAlpha:85,showBorder:1,borderColor:'#D5CDBE',borderThickness:0.5,nullEntityColor:'FFF9F5',entityFillHoverColor:'#606060',entityFillHoverAlpha:85},colorrange:{gradient:1,code:'#0f5499'}},// Overlapped Bar2D Chart (95)
...
scrollbar2d:{chart:{drawCrossLine:1,flatscrollbars:1,scrollHeight:17,scrollColor:'#F2E5D9'}},// Scroll Stacked Bar2D Chart (98)
scrollstackedbar2d:{chart:{drawCrossLine:1,flatscrollbars:1,scrollHeight:17,scrollColor:'#F2E5D9'}},// Scroll Multi-series Stacked Column2D Chart (99)
